package com.teamfoundationandroid.app.demo;
...
public class UserSettingsDemoFragment extends Fragment {
    ...
    private void setThemeColors(final Theme theme) {
        UserSettings.getInstance().setTitleTextColor(theme.titleTextColor);
        UserSettings.getInstance().setBackgroundColor(theme.backgroundColor);
        UserSettings.getInstance().setTitleBarColor(theme.titleBarColor);
        ...
        new AsyncTask<Void, Void, Void>() {
            ...
            protected void onPostExecute(final Void aVoid) {
                ...
                UserSettings.getInstance().getDataset().synchronize(new Dataset.SyncCallback() {
                    @Override
    ...
    private void loadUserSettings() {
        final Dataset dataset = UserSettings.getInstance().getDataset();
        ...
        dataset.synchronize(new DefaultSyncCallback() {
            ...
            public void onSuccess(final Dataset dataset, final List<Record> updatedRecords) {
                ...
                UserSettings.getInstance().loadFromDataset();
                updateUI(dialog);
            }
